...
<tr>
 ...
 <b><font size=5>회원가입</font></b><br><br>
 </td>
</tr>


 <tr><td>아이디  </td><td><input type="text" name="id" onkeyup="ckId(this)" placeholder="아이디를 입력하세요"><br>
...
<form method="post" action="a.jsp">
	아이디:<input type="text" name="id" onkeyup="ckId(this)" placeholder="아이디를 입력하세요"/>
...
if(isCheck){
	...
	if(hasId=="Y"){
		...
		alert("등록 가능한 아이디입니다.");
		document.querySelector("[name=id]").value="<%=id2%>"
	}
}
</script>
<%
