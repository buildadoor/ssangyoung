 ...
 */
	...
	public Lecture02(String day, int t01, int t02) {
		this.day = day;
		this.t01 = t01;
		this.t02 = t02;
	}
	...
	public Lecture02(String lecName, String lecLoc, String times, String day, int t01, int t02) {
		this.lecName = lecName;
		this.lecLoc = lecLoc;
		this.times = times;
		this.day = day;
	...
	public Lecture02(int lecNum) {
		this.lecNum = lecNum;
	}


	public Lecture02(int class_I, String majorName) {
	...
	public Lecture02(int lecNum,String majorName,int class_I,String sort, String lecName,String lecLoc,String times, int grade) {
		this.lecNum = lecNum;
		this.lecName = lecName;
		this.lecLoc = lecLoc;
		this.grade = grade;
	...
	public Lecture02(int lecNum, String lecLoc, String lecPlan, int lecYear, int semester, int grade, String majorName,
