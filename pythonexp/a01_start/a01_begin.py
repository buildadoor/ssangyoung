...
print("문장3",end="\t")
print()
#print()는 기본적으로 줄바꿈을 포함한다. 다음 명령문과 이어줄 떄는 end 속성을 통해서 다음 명령에 
#대한 처리 방식을 선언할 수 있다.
...
3. 입력함수와 형변환 함수를 이중으로 적용하며
    int(intput("숫자"))를 활용하여 처리할 수 있다.
'''
...
# print(num01,"×",num02,"=",num01*num02)
# print(num01,"÷",num02,"=",num01/num02)
# ex) 물건가격과 갯수를 입력받아 총계를 출력ㅎ세요
price = int(input("물건가격 입력: "))
cnt = int(input("물건갯수 입력: "))
print("총계:",price*cnt)
