...
4. seed    
    한번 실행하여 출력된 랜덤값은 다시 실행하여도 동일하게 처리하려면
...
#ex) 5x5 크기로 랜덤 범위를 지정하여 출력하세요.
print(np.random.normal(size=(5,5)))

#np.random.seed(seed=100)
#seed가 100일때...: seed를 정하면 한번 실행한 후는 해당 seed에 따라
#동일한 랜덤 데이터가 나온다.
...
# ex) 1-6까지 주사위 10번 던진 데이터를 출력
print(np.random.randint(1,7,size=10))
# ex) 4X4로 학생의 점수(1-100)
