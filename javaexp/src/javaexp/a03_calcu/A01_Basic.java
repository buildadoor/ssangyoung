...
7. 논리
	...
	age>=14 && age<=18 두가지 비교연산자가 모두 true 일때 true
	ex) id, pass 동일시
	id == "himan" && pass = "7777"
	id.equals("himan") && pass.equals("7777")
	
	*****주의
	자바는 위와같이 비교연산자로 문자열을 비교하면 안된다. equals
	"" ==> new String("") ==> heap영역 사용.
	String idl = new String("himan");
...
2. 산술연산자 우선순위
	...
	ps) () - 소괄호
 	...
 	대입연산자 : 오른쪽에서 왼쪽으로 처리된다.
			...
			/*
			 * #부호 연산자
			 피연산자에 부호 기호 (+,_)를 붙여 양수와 음수를 처리하는 것을 말한다.
			 */
...
System.out.println("num04:"+num03);
...
System.out.println("내용:"+eat);
System.out.println("지출:"+out);
System.out.println("수입:"+in);
System.out.println("현재잔액:"+tot);
*/
//해설
	String date = "8/31";
	String con = "차비";
