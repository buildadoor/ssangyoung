...
public class A01_Begin {
	...
	try {
		...
		System.out.println("예외 발생 없이 처리 할 코드");
	}
			System.out.println("번호:"+(++num01));
			System.out.println("번호:"+(++num01));
			System.out.println("번호:"+(++num01));
...
1. 오류의 종류
	...
	3) 구분
		- 일반(컴파일 체크) 예외
			...
			eclipse 툴에서는 자동적으로 이에대한 소스를 자동으로
...
4. 예외 처리 코드 
	...
	4) 강제 예외 처리 (throw new 예외처리클래스())
	 코드상 특정 조건이나 특정 위치에서 개발자가 사용자 정의 또는
	 내정된 예외를 직접적으로 던지고, 해당 예외를 catch구문으로 처리하는 것 
	 try{
		 if(cnt ==5){
