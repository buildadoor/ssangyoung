...
public class A01_Random {
	...
	public static void main(String[] args) {
		...
		/*
		 # 임의의 수를 처리하는 Math.radom()
		 1. Math.random()는 Math클래스 하위에 static 메서드로
		 	0.0<=Math.random()<1.0
		 2.임의의 수를 처리하기
		 	0.0<=Math.random()<1.0*10
		 	0<=(int)Math.random()*10<10 0~9 10가지의 경우수로 
		 	1<=(int)Math.random()*10+1)<11 1~10 10가지의 경우수로 
			1~10까지 10가지의 임의의 정수처리.
		 3. 임의의 정수 처리 공식 
			(int)(Math.random()*경우의수+1)
		 	1) 주사위를 임의로 처리하기 
		 		6가지의 경우수 
		 		1~6 : 시작은 1부터 
		...
		// ex1)홀짝을 임의로 처리를 1,2기 임의로 나오게 하세요.
		// 2가지의 경우수 , 시작수는 1
		...
		// ex3) 100점 만점 점수 (0~100)가 임의로 나오게 하세요
		//경우의 수가 1~100가 100, 0부터 100까지는 경우의 수 101
		//시작수는 0
