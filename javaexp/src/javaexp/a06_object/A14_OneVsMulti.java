...
class ShoppingMall{
	...
	public void regdateMember(Member m) {
		this.mlist.add(m);
		System.out.println(m.getId()+"회원이 추가되었습니다");
	}
	public void regMemAll(ArrayList<Member>list) {
//		this.mlist = list;	전체 데이터 덮어씌우기 
		this.mlist.addAll(list); // 기존 list 추가 
