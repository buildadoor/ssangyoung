...
class Company{
	...
	int empNum;
	int earMoney;
	Company(){} //프로그래머가 생성자를 추가할때 default 생성자는 더이상
	//만들어지지 않지만, 사용자 정의로 정의할때 사용 
//	Company(){}
	Company(String name){
		this.name = name ; 
		//this : 현재 전체 객체를 지칭
		// 이 객체가 가지고 있는 구성요소를 호출할 때 사
	}	
