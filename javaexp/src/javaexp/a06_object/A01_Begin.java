 ...
 */
		 ...
		 */
		// ex) Computer 클래스, HandPhone클래스, Food클래스를 선언하고, main()안에서
		//	객체를 생성하여 각 2개 이상씩 객체르 생성하고, 객체의 참조변수를 출력하세요
		Computer c1 =new Computer();
		Computer c2 =new Computer();
		HandPhone h1 =new HandPhone();
		HandPhone h2 =new HandPhone();
		Food f1 =new Food(); //선언된 클래스로 부터 여러개의 객체를 만든다.
		Food f2 =new Food(); //선언된 클래스로 부터 여러개의 객체를 만든다.
		System.out.print(c1); //heap영역의 주소값을 가지고 있다. 
