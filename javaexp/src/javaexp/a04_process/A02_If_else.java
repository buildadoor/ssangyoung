...
public class A02_If_else {
	...
	/*	int gIdx1 = (int)(Math.random()*2);//0.1
		...
		System.out.println("게임시작 홀/짝을 선택하세요:");
		String ch = sc.nextLine(); // 홀or짝 선택
		String com = "";
		System.out.println("컴퓨터의 선택:");
		if(gIdx1==0) { //위에 임의로 값이 0
	...
	//if else 이용하여 나이가 14세 이상 18세 미만이면
	...
	}else if(point>=80) { //주의 앞에 90점 이상 제외 하고 else
	...
	// ex) 0,1,2가 임의로 나오게 하여 
	//컴퓨터가 가위/바위/보를 출력하게 하세요
/*	int gIdx02 = (int)(Math.random()*3);
	Scanner sc = new Scanner(System.in);
