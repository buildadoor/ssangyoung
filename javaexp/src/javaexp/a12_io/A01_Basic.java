...
public class A01_Basic {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 데이터를 입력할때, 사용되는 객체이다.
		 	...
		 	바라보기때문에 정상적인 작동을 할 수 없다.
		 	이런 여러가지 IO를 보완한 Scanner()는 이런 처리를 피할 수 있지만
		 	raw 소스로는 주석처리하든지 다른 파일을 실행하여야한다. 	
		 ...
		 4. 입력 처리를 하는 InputStream||
		 	...
		 	1) 주요 메서드
		 		read() : 문자(char) ==> byte code값으로 연결되어 있어서, 저장되는 것은 정수형이라고 할 수 있다.
		 								이것은 char로 코드값과 연결도어 있는 문자로 변경되어
		 								표현하고 처리할 수 있다.
	...
	//	System.out.println((int)'1');
		...
		//console창에서 문자 한자를 입력받기위해 InputStream 객체 할당
		is = System.in; //자바에서 기본지원 입력 객체 하단 Console창에서 처리
		//입력할때, 데이터를 처리해줄 수 있는 객체.
		...
		/*
		 ...
		 처리를 해주어야 실행을 할 수 있다.
		 ex) int num01 = is.read(); // read()기능 메서드를 통해 io가
		 발행하므로 예외 처리를 한다. 
		...
		//A02_InputStreamExp.java를 만들고,
		//InputStream에 의해서 정답을 입력하세요(1~4)를 통해
		//입력받고, 해당 정답이 3번이면 정답 그외에는 오답 처리하세요 
		//'3'vs3==>다름 , code값과 코드는 다름 .
