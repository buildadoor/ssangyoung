...
/*
 		...
 		2. 접근 제한자의 종류
 			...
 			- protected : 상속 관계에 있을때, 외부 패키지까지 접근 가능
 			- default(X) : 같은 패키지에서만 접근가능 
	...
	*/
		...
		//같은 패키지는 생성자가 default 접근 제어자이어도 접근이 가능 
		A01_Person pson; //다른 패키지에 있는 클래스 호출
	//	A02_Music music;//다른 패키지에 있는 클래스가 public이 아닐때 에러 
		pson = new A01_Person(); 
		A01_Person pson2;
//		pson2 = new A01_Person"홍길동"; 생성자가 default 접근제어자 이기에 에러발생. 
		/*
		 ...
		 2. 호출하는 클래스가 다른 패키지인 경우 접근 제어자가 public인 경우에 class 선언이 가능하고
