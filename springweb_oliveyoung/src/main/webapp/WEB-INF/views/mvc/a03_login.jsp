...
$(document).ready(function(){
 ...
 var msg = "${msg}";
 if(msg!="초기화면") alert("아이디 혹은 비밀번호가 틀렸습니다. 다시 로그인해주세요")
</script>
</head>
<body>
...
<!-- Topbar Start -->
        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-4 d-none d-lg-block">
                <a href="${path}/main.do" class="text-decoration-none">
                  　<img id="goMain" style="width:80%" src="${path}/resources/img/main.png">
                </a>
            </div>
    ...
    <h4 style="margin-left:50%;">로그인</h4>
    <br>
    <div class="input-group">
    <input type="text" style="margin-left:43%; width:20%;" name="id" placeholder="CJ ONE 통합회원 아이디 입력"/><br><br>
    <input type="password" style="margin-left:43%; width:20%;" name="pass" placeholder="비밀번호(8-12자 영문자+숫자+특수문자)"/><br><br>
    </div><br>
    <button style="margin-left:50%; background-color:#A6CD48;"   id="loginbtn" >로그인</button>
    </form>
	<br><br>
    <!-- Login End -->
