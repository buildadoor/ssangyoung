...
--> 
<script src="<c:url value="/a00_com/jquery.min.js"/>"></script>
<script src="<c:url value="/a00_com/popper.min.js"/>"></script>
<script src="<c:url value="/a00_com/bootstrap.min.js"/>"></script>
<script src="<c:url value="/a00_com/jquery-ui.js"/>"></script>
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div style="margin-left:150px;" class="col-lg-4 col-4">
               <a class="text-dark joinBtn" >회원가입</a>
               <span class="text-muted px-2">|</span>
               <a class="text-dark"id="goLogin">로그인</a>
               <span class="text-muted px-2">|</span>
               <a class="text-dark" href="${path}/cs.do">고객센터</a>
        </div>
    </div>
    </div>
    <!-- Topbar End -->
