...
<!-- Topbar Start -->
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div style="margin-left:150px;" class="col-lg-4 col-4">
               <!-- 회원가입 -->
               <a class="text-dark" id="goReg">회원가입</a>
    ...
    <!-- Navbar End -->
      ...
      <!-- main -->
    <h2 style="font-weight:bold;margin-left:320px;margin-top:30px;"></h2>
	<div class="row">
		<div class="col-2"></div>
		...
		<form id="frm01" class="form"  method="post">
			<div style="margin-top:15px;" class="row text-center">
				<div class="col">
					...
					<input type="text" size="10"  name="prodNo" value="${sch.prodNo}" placeholder="상품 번호 입력">
				</div>
				<div class="col">
					<span style="font-size:18px;font-weight:bold;"> </span>
					<input type="text" size="10" name="prdName" value="${sch.prdName}" placeholder="상품명 입력">
				</div>    
	...
	<col width="5%">
   	...
   	<col width="25%">
			...
			<tbody>
			<c:forEach var="OvProduct" items="${OvProductList}">
    		<tr>
    		<td>${OvProduct.prodNo}</td>
    		<td>${OvProduct.ctgNo}</td>
    		<td>${OvProduct.prdName}</td>
    		<td>${OvProduct.prdKind}</td>
    		<td>${OvProduct.prdPrice}</td>
    		<td>${OvProduct.prdDescript}</td>
    		<td><img style="width:100%" 
    		src="${path}/resources/img/${OvProduct.prdName}.jpg"></td>
    		</tr>
    		</c:forEach>
			</tbody>
			</table>
