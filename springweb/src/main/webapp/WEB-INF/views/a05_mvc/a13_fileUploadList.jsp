...
<div class="container">
   <form id="frm01" class="form"  method="post">
     <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
       ...
       <button data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-success" type="button">Search</button>
    ...
    <tbody>
        <c:forEach var="fObj" items="${flist}">
          <tr><td>${fObj.no}</td><td>${fObj.title}</td>
             <td>${fObj.fname}</td>
             <td><fmt:formatDate value="${fObj.no}"/></td></tr>
       </c:forEach> 
    </tbody>
   </table>    
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button id="regBtn" type="button" class="btn btn-primary">파일 첨부</button>
