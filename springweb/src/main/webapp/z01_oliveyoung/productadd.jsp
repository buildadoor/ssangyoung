...
<body>
    ...
    <!-- Product Start -->
    <br><br><br><br><br>
    <h3 style="margin-left:50%;">상품등록</h3>
    <br>
    <div class="input-group">
    <table style="margin-left:30%; width:50%;">
    <tr><td id="gray">카테고리<br>번호</td><td colspan="2">
     <select>
    ...
    <tr><td id="gray">상품<br>번호</td><td colspan="2">
    <select>
    ...
    <tr><td id="gray">상품 종류</td><td colspan="2">
 	<select>
 	    <option value="">기초</option>
    	<option value="">색조</option>
    	<option value="">메이크업툴</option>	
    </select>
    </td></tr>
    <tr><td id="gray">브랜드</td><td colspan="2"><input type="text" name="name"></td></tr>
    <tr><td id="gray">상품명</td><td colspan="2"><input type="text" name="name"></td></tr>
    <tr><td id="gray">상품 가격</td><td colspan="2"><input type="text" name="name"></td></tr>
    <tr><td id="gray">상품 설명</td><td colspan="2">
  <textarea rows="10" cols="85" 
	placeholder="상품 설명을 입력하세요" name=""></textarea>
    </td></tr>
    <tr><td id="gray">배송정보</td><td colspan="2"><input type="text" name="name"></td></tr>
    <tr><td id="gray">상품이미지</td><td colspan="2">
    ...
    <button style="margin-left:68%;" id="cancelbtn">수정</button>
