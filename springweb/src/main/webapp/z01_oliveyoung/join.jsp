...
<body>
    ...
    <!-- Login Start -->
    <br><br><br><br><br>
    <h3 style="margin-left:50%;">회원가입</h3>
    <h4 style="margin-left:20%;">기본정보</h4>
    <span style="margin-left:67%;" id="red">⩗</span>표시는 필수 입력 항목입니다.
    <br>
    <div class="input-group">
    <table style="margin-left:20%; width:60%;">
    <tr><td id="red">⩗　</td><td id="gray">이름</td><td colspan="2"><input type="text" name="name"></td></tr>
    <tr><td id="red">⩗　</td><td id="gray">아이디</td><td colspan="2"><input type="text" name="name"><button id="joinbtn">중복확인</button></td></tr>
    <tr><td id="red">⩗　</td><td id="gray">비밀번호</td><td colspan="2"><input type="text" name="name">
    <a id="etc"><br>영문자,숫자,특수문자 조합하여 8-12자리, 아이디와 4자리이상 동일, 반복 문자숫자 불가<br>사용가능 특수 문자:!"#$%&'()*+,-./:;<=>?@^-'{|}~</a></td></tr>
    <tr><td id="red">⩗　</td><td id="gray">비밀번호 확인</td><td colspan="2"><input type="text" name="name"></td></tr>
    <tr><td id="red">⩗　</td><td id="gray">생년월일</td><td colspan="2">
    <input type="date" name="userBirth" required="required"/>
    <br><a id="etc">설정하신 생일을 기준으로 15일 전 생일쿠폰이 발행됩니다.</a>
    </td></tr>
    <tr><td id="red">⩗　</td><td id="gray">휴대전화번호</td><td colspan="2">
    <select>
     <option> 010 </option>
     <option> 011 </option>
     <option> 016 </option>
    ...
    <br><a id="etc">주문 및 배송,쿠폰,이벤트 정보 등을 제공받으실 수 있습니다.</a>
    </td></tr>
    <tr><td id="red">⩗　</td><td id="gray">이메일</td><td colspan="2">
    ...
    <br><a id="etc">이메일 주소 입력 시 사용 가능 특수 문자:._</a>
    </td></tr>
    </table>
    </div><br>
    <h4 style="margin-left:20%;">선택정보</h4>
    <table style="margin-left:20%; width:60%;">
    <tr><td id="gray">　
    마케팅 채널<br>　수신 선택</td><td colspan="2"><a id="etc">포인트/이벤트/상품 소식을 전해드립니다.(공지목적의 발송되는 메일은 제외)</a><br>
        <input type = "checkbox" name = ""/>전체동의 <input type = "checkbox" name = ""/>이메일<input type = "checkbox" name = ""/>SMS<input type = "checkbox" name = ""/>휴대전화

    </td></tr>
    </table>
    
    <button style="margin-left:45%;" id="cancelbtn">취소</button>
    <button id="joinbtn">등록</button>
	<br><br><br><br><br>
    <!-- Login End -->
