...
// http://localhost:7080/springweb/student.do
	 ...
	 //ex) http://localhost:7080/springweb/buyProduct.do
	   ...
	   public String buyProduct01(
	      ...
	      return "WEB-INF\\views\\a01_start\\a13_buyProduct.jsp";
	   }
	   /*
	    <input name="pname"/>
	    <input name="price"/>
	    ...
	    <h2>구매 물건은 ${param.pname} 총비용은 ${total}
	    */
	}
