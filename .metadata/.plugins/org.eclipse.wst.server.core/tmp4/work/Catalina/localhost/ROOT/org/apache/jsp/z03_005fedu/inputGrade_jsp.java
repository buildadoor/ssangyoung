 ...
 * Generated at: 2023-01-04 06:19:03 UTC
...
public final class inputGrade_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
 	...
 	request.setCharacterEncoding("utf-8");
      ...
      out.write("                     <div id=\"subtitle\">성적입력/수정</div>\r\n");
      out.write("					 <div id=\"btn\">\r\n");
      out.write("					 	<a onclick=\"send()\" class=\"entry\"><span>입력/수정</span></a>\r\n");
      out.write("					 	<a onclick=\"backPage()\" class=\"del\"><span>취 소</span></a>\r\n");
      out.write("					 </div>\r\n");
      ...
      out.write("                         <thead>\r\n");
      out.write("                            <tr>\r\n");
      out.write("                            	<th>학번</th><th>이름</th><th>학과</th><th>중간고사(40%)</th>\r\n");
      out.write("                            	<th>기말고사(40%)</th><th>출결일수(20%)</th><th>총점</th>\r\n");
      out.write("                            </tr>\r\n");
      out.write("                         </thead>\r\n");
      out.write("                         <tbody>\r\n");
      out.write("                         	");
      ...
      out.print(id );
      out.write("'\r\n");
      out.write("		var attendanceOb = document.querySelector(\"[name=attendance]\")\r\n");
      out.write("		var midtestOb = document.querySelector(\"[name=midtest]\")\r\n");
      out.write("		var endtestOb = document.querySelector(\"[name=endtest]\")\r\n");
      out.write("		var selectOb = document.querySelector(\"#sel\")\r\n");
      out.write("		var optionOb = document.querySelectorAll(\"#sel option\")\r\n");
      out.write("		var hiddenOb = document.querySelector(\"[name=hidden]\") \r\n");
      out.write("		\r\n");
      out.write("		// 총점 선택되어질 수 있도록\r\n");
      out.write("		// value값 비교 후 값이 동일하면 selected\r\n");
      out.write("		for(var i = 0; i < optionOb.length; i++){\r\n");
      out.write("			if(optionOb[i].value == hiddenOb.value){\r\n");
      out.write("				optionOb[i].selected = true;\r\n");
      out.write("			}\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		//성적 입력/수정\r\n");
      out.write("		function send() {\r\n");
      out.write("			if(attendanceOb.value < 0 || attendanceOb.value > 100 || isNaN(attendanceOb.value)){\r\n");
      out.write("				Swal.fire({\r\n");
      out.write("					  title: '출결 값을 확인하세요.',\r\n");
      ...
      out.write("					  }\r\n");
      out.write("					})\r\n");
      out.write("			}else if(midtestOb.value < 0 || midtestOb.value > 100 || isNaN(midtestOb.value)){\r\n");
      out.write("				Swal.fire({\r\n");
      out.write("					  title: '중간고사 값을 확인하세요.',\r\n");
      out.write("					  icon: 'warning',\r\n");
      out.write("					  showCancelButton: false,\r\n");
      out.write("					  confirmButtonColor: '#3085d6',\r\n");
      out.write("					  confirmButtonText: '확인'\r\n");
      ...
      out.write("					  }\r\n");
      out.write("					})\r\n");
      out.write("			}else if(endtestOb.value < 0 || endtestOb.value > 100 || isNaN(endtestOb.value)){\r\n");
      out.write("				Swal.fire({\r\n");
      out.write("					  title: '기말고사 값을 확인하세요.',\r\n");
      out.write("					  icon: 'warning',\r\n");
      out.write("					  showCancelButton: false,\r\n");
      out.write("					  confirmButtonColor: '#3085d6',\r\n");
      out.write("					  confirmButtonText: '확인'\r\n");
      ...
      out.write("					})\r\n");
      out.write("			}else{\r\n");
      out.write("				var qstr = \"?attendance=\"+attendanceOb.value+\"&midtest=\"+midtestOb.value\r\n");
      out.write("						+\"&endtest=\"+endtestOb.value+\"&total=\"+selectOb.value+\"&id=\"+id+\"&lecNum=\"+lecNum;\r\n");
      out.write("				location.href=\"input.jsp\"+qstr;\r\n");
      out.write("			}\r\n");
      out.write("\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		// 취소 클릭시 수강생 조회 페이지로 이동\r\n");
      out.write("		var lecNum = '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${lecNum}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("'\r\n");
  ...
  private boolean _jspx_meth_fmt_005frequestEncoding_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /z03_edu/inputGrade.jsp(15,1) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /z03_edu/inputGrade.jsp(107,9) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /z03_edu/inputGrade.jsp(108,9) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${lecNum eq lecNumInt}", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /z03_edu/inputGrade.jsp(132,26) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("stds");
      // /z03_edu/inputGrade.jsp(132,26) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/z03_edu/inputGrade.jsp(132,26) '${dao.schStudent(sch)}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${dao.schStudent(sch)}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("                            <tr>\r\n");
            out.write("								<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${stds.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("								<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${stds.stdName}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("								<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${stds.majorName}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("								<td><input type=\"number\" name=\"midtest\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${stds.midtest}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\"></td>\r\n");
            out.write("								<td><input type=\"number\" name=\"endtest\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${stds.endtest}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\"></td>\r\n");
            out.write("								<td><input type=\"number\" name=\"attendance\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${stds.attendance}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\"></td>\r\n");
            out.write("								<td>\r\n");
            ...
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${stds.total}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
