 ...
 * Generated at: 2023-01-03 09:33:38 UTC
...
public final class std_005finform_005fupt_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	request.setCharacterEncoding("utf-8");
      ...
      out.write("							</div>\r\n");
      out.write("							<div>\r\n");
      out.write("								<span class=\"span-margin\">학적 관리 > 학적정보 변경</span>\r\n");
      out.write("							</div>\r\n");
      out.write("						</div>\r\n");
      out.write("					</div>\r\n");
      out.write("					<div class=\"main-box-flex\">\r\n");
      ...
      out.write("							<div>\r\n");
      out.write("								<h3 style=\"margin:30px\">학적정보 변경</h3>\r\n");
      out.write("								<form method=\"post\" name=\"uptForm\" align=\"center\">\r\n");
      out.write("								<input type=\"hidden\" name=\"proc\"/>\r\n");
      out.write("								<table align=\"center\" style=\"height:300px;\">\r\n");
      out.write("								<colgroup>\r\n");
      out.write("									<col width=\"200px\">\r\n");
      out.write("									<col width=\"300px\">\r\n");
      out.write("								</colgroup>\r\n");
      out.write("									<tr><th>아이디(학번)</th><td style=\"padding-left:10px;text-align:left;border:1px solid #D8D9DA;\">");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${mem.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\r\n");
      out.write("									<input id=\"input01\" type=\"hidden\" name=\"id\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${mem.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"/></td></tr>\r\n");
      out.write("									<tr><th>주소*</th><td><input id=\"input01\" type=\"text\" name=\"address\"\r\n");
      out.write("										placeholder=\"변경할 주소를 입력하세요\"/><span id=\"ckadd\"></span></td></tr>\r\n");
      out.write("									<tr><th>전화번호*</th><td><input id=\"input01\" type=\"text\" name=\"stdPhone\"\r\n");
      out.write("										placeholder=\"변경할 전화번호를 입력하세요\"/><span id=\"ckphone\"></span></td></tr>\r\n");
      out.write("									<tr><th>이메일*</th><td><input id=\"input01\" type=\"text\" name=\"stdEmail\"\r\n");
      out.write("										placeholder=\"변경할 이메일를 입력하세요\"/><span id=\"ckemail\"></span></td></tr>\r\n");
      out.write("								</table>\r\n");
      out.write("								<input type=\"button\" class=\"btn\" value=\"변경\" onclick=\"uptIn(");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${mem.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(");\"/>\r\n");
      out.write("								</form>\r\n");
      out.write("							</div>\r\n");
      ...
      out.write("	uptForm.address.focus();\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function uptIn(id){\r\n");
      out.write("	var addressV = document.querySelector(\"[name=address]\").value\r\n");
      out.write("	var stdPhoneV = document.querySelector(\"[name=stdPhone]\").value\r\n");
      out.write("	var stdEmailV = document.querySelector(\"[name=stdEmail]\").value\r\n");
      out.write("	if(addressV==\"\" || stdPhoneV==\"\" || stdEmailV==\"\"){\r\n");
      out.write("		if(addressV==\"\"){\r\n");
      out.write("			alert(\"주소 입력은 필수입니다.\")\r\n");
      out.write("			address.focus();\r\n");
      out.write("		}else if(stdPhoneV==\"\"){\r\n");
      out.write("			alert(\"전화번호 입력은 필수입니다.\")\r\n");
      out.write("			stdPhone.focus();\r\n");
      out.write("		}else if(stdEmailV==\"\"){\r\n");
      out.write("			alert(\"이메일 입력은 필수입니다.\")\r\n");
      out.write("			stdEmail.focus();\r\n");
      out.write("		}\r\n");
      out.write("	}else{\r\n");
      out.write("		if(confirm(\"변경하시겠습니까?\")){\r\n");
      out.write("			document.querySelector(\"form\").action=\"std_inform_ckupt.jsp\"\r\n");
      out.write("			document.querySelector(\"[name=proc]\").value=\"upt\";\r\n");
  ...
  private boolean _jspx_meth_fmt_005frequestEncoding_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /z03_edu/std_inform_upt.jsp(12,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
