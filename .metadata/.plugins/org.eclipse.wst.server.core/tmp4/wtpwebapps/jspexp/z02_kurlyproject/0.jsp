...
<form method="post" action="a.jsp">
	아이디:<input type="text" name="id" onkeyup="ckId(this)"/>
	<input type="submit" value="중복여부" />
	<br><span id="check"></span><br>
</form>
비밀번호 <input type="password" name="password" placeholder="비밀번호를 입력하세요">
이름  <input type="text" name="uname" placeholder="이름을 입력하세요">
주민등록번호  <input type="text" name="rrn" placeholder="'-'을 포함하여 입력하세요" >
핸드폰번호  <input type="text" name="phonenumber" placeholder="'-'을 포함하여 입력하세요">
주소 <input type="text" name="address" placeholder="주소를 입력하세요">
<input type="submit" value="회원가입" onclick="ckValid()" id="bt">
<%
