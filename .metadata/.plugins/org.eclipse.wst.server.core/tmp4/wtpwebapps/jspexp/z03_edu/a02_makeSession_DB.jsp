...
<jsp:useBean id="dao" class="jspexp.a13_database.eduloginDao" />
<jsp:useBean id="reMem" class="jspexp.a13_database.member_s" />
...
<body>
   ...
   %>
   <jsp:useBean id="pro" class="jspexp.a13_database.Professor"/>
