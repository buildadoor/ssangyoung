...
2. 각 프레임간의 데이터 전송 
	1) 클라이언트단의 BOM객체나 DOM객체간의 접근 방법
 ...
 <script>
 	...
 	function call02(){
 		...
 		fm02H2Ob.style.color="red"
 	} 
 	var win;
 	function call03(){
 		win = window.open("a06_sub.jsp","","width=300pt, height=3000pt")
 		//<h2>윈도우창로딩</h2>
 	}
 	function call04(){
