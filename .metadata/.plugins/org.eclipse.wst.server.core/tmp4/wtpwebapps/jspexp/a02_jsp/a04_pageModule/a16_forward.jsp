...
--%>
<%
	pageContext.setAttribute("pag_name", "이윤아");
	request.setAttribute("req_name", "홍길동");
%>
<jsp:forward page="a17_goPage.jsp"/>
<%--ex) a18_forwardText.jsp?id=himan 처리하여
		요청값(request.getParameter("id"))이 himan일 때는 로그인 성공 페이지 a19_main.jsp로 전송
