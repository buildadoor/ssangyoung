...
http://localhost:7080/a02_jsp/a01_begin/a07_request.jsp?name=홍길동&num01=25&num02=30
 ...
 ex) 요청키는 pname, price, cnt로 하고 물건명, 가격, 갯수를 
 query string으로 전달하고, 화면에 h3로 물건명:@@@ 가격:@@@ 갯수:@@@@가 출력되게 하세요.
 http://localhost:7080/a02_jsp/a01_begin/a07_request.jsp?pname=사과&price=2000&cnt=6 
	2) 요청값을 query string을 기반으로
		-값이 없으면 null(객체 메모리 없음)
		-key=value 형식이 있으면 문자열로 데이터를 가져온다.
 --%>
 	<h1>요청값 연습</h1>
