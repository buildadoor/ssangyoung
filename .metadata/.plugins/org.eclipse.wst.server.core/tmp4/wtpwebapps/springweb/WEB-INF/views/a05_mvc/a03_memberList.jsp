...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#regLdBtn").click(function(){
			...
			// 속성이 name이 없으면 모두 다 default로 설정
...
<div class="container">
   ...
   <table class="table table-hover table-striped">
    ...
    <tbody>
    	...
    	그대로 처리되는 로딩하는 구분하여야한다.
    		문자열을 입력할 경우에는 반드시 '',""를 포함해서 넘겨야한다.
    	2. 	 goPage(himan) (X)
    		==> goPage('himan') (O)
    	
    		function goPage(id){
    			location.href="호출할 control.do?id="+id
    		}
    	3. 	 goPage(7000) (O)
    		 goPage('7000') (O)
    		
    		function goPage(empno){
    			location.href="호출할 control.do?empno="+empno
    		}
    	 -->
